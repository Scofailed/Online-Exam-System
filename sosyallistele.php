...
<?php 
	...
	<tr>
		...
		<td align="center"><a href="sorusil.php?soru_id=<?php echo $cek['soru_id'] ?>&sorusil=ok3"><button class="btn btn-warning"><i class="fa fa-trash"></i></button></td></a>
		<td align="center"><a href="soruguncellesosyal.php?soru_id=<?php echo $cek['soru_id'] ?>"><button class="btn btn-danger"><i class="fa fa-pencil"></i></button></td></a>
	</tr>
		<?php 
	}
