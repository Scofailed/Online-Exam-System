...
<button onclick="location.href='kullanicigiris.php' " style="width:auto;">Giriş</button>
<hr>
...
<button onclick="location.href='admingiris.php' " style="width:auto;">Giriş</button>
