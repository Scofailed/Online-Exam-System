...
<?php 
	...
	<tr>
		...
		<td align="center"><a href="sorusil.php?soru_id=<?php echo $cek['soru_id'] ?>&sorusil=ok1"><button>Sil</button></td></a>
		<td align="center"><a href="soruguncelleturkce.php?soru_id=<?php echo $cek['soru_id'] ?>"><button>Güncelle</button></td></a>
	</tr>
		<?php 
	}
