...
<?php 
	...
	$listele=$db->prepare("Select * from turkcesoru order by soru_derece");
	$listele -> execute();
	...
	<tr>
		...
		<td align="center"><a href="sorusil.php?soru_id=<?php echo $cek['soru_id'] ?>&sorusil=ok1"><button class="btn btn-danger"><i class="fa fa-trash"></i></button>
</td></a>
		<td align="center"><a href="soruguncelleturkce.php?soru_id=<?php echo $cek['soru_id'] ?>">
<button class="btn btn-warning"><i class="fa fa-pencil"></i></button></td></a>
	</tr>
		<?php 
	}
