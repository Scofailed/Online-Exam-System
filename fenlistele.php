...
<h2>Listeleme İşlemleri</h2>
	...
	<a href="adminpaneli.php"><input class="adminpaneli btn btn-success" type="button" name="button2" id="button2" value="Admin Paneli" /></a>
...
<?php 
	...
	$listele=$db->prepare("Select * from fensoru order by soru_derece");
	$listele -> execute();
	...
	<tr>
		...
		<td align="center"><a href="sorusil.php?soru_id=<?php echo $cek['soru_id'] ?>&sorusil=ok4"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></td></a>
		<td align="center"><a href="soruguncellefen.php?soru_id=<?php echo $cek['soru_id'] ?>"><button class="btn btn-warning"><i class="fa fa-pencil"></i></button></td></a>
	</tr>
		<?php 
	}
