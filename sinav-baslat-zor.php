...
$sorulistele=$db->prepare("select * FROM ((select * FROM turkcesoru WHERE soru_derece='kolay' LIMIT 10) UNION ALL (select * FROM turkcesoru WHERE soru_derece='orta' LIMIT 10) UNION ALL (select * FROM turkcesoru WHERE soru_derece='zor' LIMIT 20)) turkcesoru");
$sorulistele->execute();
...
<?php
$i=1;
$sorulistele=$db->prepare("select * FROM ((select * FROM matematiksoru WHERE soru_derece='kolay' LIMIT 10) UNION ALL (select * FROM matematiksoru WHERE soru_derece='orta' LIMIT 10) UNION ALL (select * FROM matematiksoru WHERE soru_derece='zor' LIMIT 20)) matematiksoru");
$sorulistele->execute();
...
<?php
$i=1;
$sorulistele=$db->prepare("select * FROM ((select * FROM sosyalsoru WHERE soru_derece='kolay' LIMIT 10) UNION ALL (select * FROM sosyalsoru WHERE soru_derece='orta' LIMIT 10) UNION ALL (select * FROM sosyalsoru WHERE soru_derece='zor' LIMIT 20)) sosyalsoru");
$sorulistele->execute();
...
<?php
$i=1;
$sorulistele=$db->prepare("select * FROM ((select * FROM fensoru WHERE soru_derece='kolay' LIMIT 10) UNION ALL (select * FROM fensoru WHERE soru_derece='orta' LIMIT 10) UNION ALL (select * FROM fensoru WHERE soru_derece='zor' LIMIT 20)) fensoru");
$sorulistele->execute();
